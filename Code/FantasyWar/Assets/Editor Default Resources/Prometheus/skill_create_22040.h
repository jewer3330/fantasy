...
//变量声明
uint64_t Variable_22040_Damage = 0;
uint64_t Variable_22040_EnableDmg = 0;
uint64_t Variable_22040_Effect = 0;
//--------------------------------------------------------------------------------
// StartPhase
//
REGISTER_REGISTER_SKILL_NODE(22040, 19) {
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(22040, 21) {
...
REGISTER_CREATE_SKILL_NODE(22040, 21) {
    ...
    if (variables != nullptr) {
        node21->setA(variables->getVariable<int32_t>(Variable_22040_Damage));
    }
    return node21;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22040, 22) {
...
REGISTER_CREATE_SKILL_NODE(22040, 22) {
    ...
    if (node22 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 22, node22)
    }
    if (noInit == true) {
        return node22;
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(22040, 23) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(22040, 24) {
...
REGISTER_CREATE_SKILL_NODE(22040, 24) {
    ...
    if (node24 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 24, node24)
    }
    if (noInit == true) {
        return node24;
    }
...
// PlayEffect
//
REGISTER_REGISTER_SKILL_NODE(22040, 25) {
...
REGISTER_CREATE_SKILL_NODE(22040, 25) {
    ...
    if (node25 == nullptr) {
        ...
        node25->setScale(.00f);
        CALL_REGISTER_SKILL_NODE(22040, 25, node25)
    }
    if (noInit == true) {
        return node25;
    }
...
// Delay
//
REGISTER_REGISTER_SKILL_NODE(22040, 26) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(22040, 27) {
    pnode->resizeTrigger(PhaseNode_PlayAnimation::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22040, 27) {
    ...
    if (node27 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 27, node27)
    }
    if (noInit == true) {
        return node27;
    }
...
// RemoveSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(22040, 28) {
...
REGISTER_CREATE_SKILL_NODE(22040, 28) {
    ...
    if (node28 == nullptr) {
        ...
        node28->setTarget(0U);
        CALL_REGISTER_SKILL_NODE(22040, 28, node28)
    }
    if (noInit == true) {
        return node28;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22040, 29) {
}

REGISTER_CREATE_SKILL_NODE(22040, 29) {
    ...
    if (node29 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 29, node29)
    }
    if (noInit == true) {
        return node29;
    }
...
// IntOperation
//
REGISTER_REGISTER_SKILL_NODE(22040, 31) {
...
REGISTER_CREATE_SKILL_NODE(22040, 31) {
    ...
    if (node31 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 31, node31)
    }
    if (noInit == true) {
        return node31;
    }
    ...
    if (variables != nullptr) {
        node31->setBase(variables->getVariable<int32_t>(Variable_22040_Damage));
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(22040, 32) {
    pnode->resizeTrigger(PhaseNode_SetInt::TRIGGER_MAX);
...
// If
//
REGISTER_REGISTER_SKILL_NODE(22040, 34) {
...
REGISTER_CREATE_SKILL_NODE(22040, 34) {
    auto node34 = GET_SKILL_NODE(34, PhaseNode_If);
    if (node34 == nullptr) {
        node34 = new PhaseNode_If(34, phase);
        CALL_REGISTER_SKILL_NODE(22040, 34, node34)
    }
    if (noInit == true) {
        return node34;
    }
    ...
    if (variables != nullptr) {
        node34->setCondition(variables->getVariable<bool>(Variable_22040_EnableDmg));
    }
    return node34;
}
//--------------------------------------------------------------------------------
...
// AddSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(22040, 38) {
...
REGISTER_CREATE_SKILL_NODE(22040, 38) {
    ...
    if (node38 == nullptr) {
        ...
        node38->setTarget(0U);
        node38->setAttribute({{}});
        CALL_REGISTER_SKILL_NODE(22040, 38, node38)
    }
    if (noInit == true) {
        return node38;
    }
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(22040, 39) {
    pnode->resizeTrigger(PhaseNode_CompareInt::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22040, 42) {
    ...
    if (variables != nullptr) {
        node42->setCondition(variables->getVariable<bool>(Variable_22040_Effect));
    }
    return node42;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22040, 44) {
    pnode->resizeTrigger(PhaseNode_SetBool::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22040, 44) {
    ...
    if (node44 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 44, node44)
    }
    if (noInit == true) {
        return node44;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22040, 45) {
}

REGISTER_CREATE_SKILL_NODE(22040, 45) {
    ...
    if (node45 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 45, node45)
    }
    if (noInit == true) {
        return node45;
    }
...
// CompareFloat
//
REGISTER_REGISTER_SKILL_NODE(22040, 46) {
...
// SkillEndNotify
//
REGISTER_REGISTER_SKILL_NODE(22040, 47) {
}

REGISTER_CREATE_SKILL_NODE(22040, 47) {
    ...
    if (node47 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 47, node47)
    }
    if (noInit == true) {
        return node47;
    }
...
// RaiseEvent
//
REGISTER_REGISTER_SKILL_NODE(22040, 48) {
...
REGISTER_CREATE_SKILL_NODE(22040, 48) {
    ...
    if (node48 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22040, 48, node48)
    }
    if (noInit == true) {
        return node48;
    }
...
// Detect
//
REGISTER_REGISTER_SKILL_NODE(22040, 49) {
...
REGISTER_CREATE_SKILL_NODE(22040, 49) {
    auto node49 = GET_SKILL_NODE(49, PhaseNode_Detect);
    if (node49 == nullptr) {
        ...
        node49->setMarkID(0);
        CALL_REGISTER_SKILL_NODE(22040, 49, node49)
    }
    if (noInit == true) {
        return node49;
    }
...
// SkillCreator_22040
//
class SkillCreator_22040 : public SkillCreator {
public:
    SkillCreator_22040() {}
    virtual ~SkillCreator_22040() {}
    virtual SkillLogic* createSkill(Skill* skill, SkillableActor* owner, uint16_t nId);
    virtual bool getSkillExpend(int32_t& nType, int32_t& nValue);
}; // class SkillCreate_22040

//--------------------------------------------------------------------------------
// SkillPhase_22040
//
class SkillPhase_22040 : public SkillPhase {
public:
    SkillPhase_22040(uint16_t id, SkillLogic* logic, uint16_t nFlow) : SkillPhase(id, logic, nFlow) {}
    virtual ~SkillPhase_22040() {}

    virtual SkillPhaseNode* createPhaseNode(uint16_t nId, bool noInit) {
        SWITCH_CREATE_SKILL_START
        CASE_CREATE_SKILL_NODE(22040, 19) // StartPhase
        CASE_CREATE_SKILL_NODE(22040, 21) // CompareInt
        CASE_CREATE_SKILL_NODE(22040, 22) // SetBool
        CASE_CREATE_SKILL_NODE(22040, 23) // SetInt
        CASE_CREATE_SKILL_NODE(22040, 24) // PlayAnimation
        CASE_CREATE_SKILL_NODE(22040, 25) // PlayEffect
        CASE_CREATE_SKILL_NODE(22040, 26) // Delay
        CASE_CREATE_SKILL_NODE(22040, 27) // PlayAnimation
        CASE_CREATE_SKILL_NODE(22040, 28) // RemoveSkillBuff
        CASE_CREATE_SKILL_NODE(22040, 29) // SetBool
        CASE_CREATE_SKILL_NODE(22040, 31) // IntOperation
        CASE_CREATE_SKILL_NODE(22040, 32) // SetInt
        CASE_CREATE_SKILL_NODE(22040, 34) // If
        CASE_CREATE_SKILL_NODE(22040, 35) // Delay
        CASE_CREATE_SKILL_NODE(22040, 38) // AddSkillBuff
        CASE_CREATE_SKILL_NODE(22040, 39) // CompareInt
        CASE_CREATE_SKILL_NODE(22040, 40) // Delay
        CASE_CREATE_SKILL_NODE(22040, 42) // If
        CASE_CREATE_SKILL_NODE(22040, 44) // SetBool
        CASE_CREATE_SKILL_NODE(22040, 45) // SetBool
        CASE_CREATE_SKILL_NODE(22040, 46) // CompareFloat
        CASE_CREATE_SKILL_NODE(22040, 47) // SkillEndNotify
        CASE_CREATE_SKILL_NODE(22040, 48) // RaiseEvent
        CASE_CREATE_SKILL_NODE(22040, 49) // Detect
        SWITCH_CREATE_SKILL_END
    }
}; // class SkillPhase_22040

SkillLogic* SkillCreator_22040::createSkill(Skill* skill, SkillableActor* owner, uint16_t nId) {
    //创建执行逻辑
    auto logic = new SkillLogic(nId, owner, skill);
    //设置变量
    Variable_22040_Damage = logic->getVariables().setVariable<int32_t>("Damage");
    Variable_22040_EnableDmg = logic->getVariables().setVariable<bool>("EnableDmg", true);
    Variable_22040_Effect = logic->getVariables().setVariable<bool>("Effect", true);
    //创建阶段phase
    auto phase = new SkillPhase_22040(1, logic, 2);
    //设置phase执行器
...
bool SkillCreator_22040::getSkillExpend(int32_t& nType, int32_t& nValue) {
    return true;
}
} // namespace pvp
