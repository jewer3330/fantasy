...
namespace SuperBoBo
{
	...
	public class EventBase
	{
		...
		public EventBase (string type, object[] args)
		{
			this.type = type;
			this.args = args;
		}
...
public delegate void EventHandleDelegate (string e, object[] args);
	...
	public class EventManager : Singleton<EventManager>
	{
		...
		private Queue<EventBase> events = new Queue<EventBase> ();
		...
		{
			EventBase et = new EventBase (e, args);
			events.Enqueue (et);
		}
		...
		/// </summary>
		/// <param name="et"></param>
		public void PushEvent (EventBase et)
		{
			if (et != null)
				events.Enqueue (et);
		}
		...
		public void FireEvent (EventBase et)
		{
			if (et != null)
				HandleEvent (et);
		}
