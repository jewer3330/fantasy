...
namespace NodeCanvas.Framework{
	...
	abstract public partial class Variable : ICloneable{
        ...
        virtual public bool ToXmlElement(System.Xml.XmlElement varElement)
        {
            return false;   //空接口
        }
	...
	///The actual Variable
	[Serializable]
	public partial class Variable<T> : Variable {
        ...
        public override object Clone()
        {
            ...
            var.objectValue = this.objectValue;
            return var;
        }
	}
