...
//变量声明
uint64_t Variable_22080_Damage = 0;
uint64_t Variable_22080_EnableDmg = 0;
uint64_t Variable_22080_Effect = 0;
//--------------------------------------------------------------------------------
// StartPhase
//
REGISTER_REGISTER_SKILL_NODE(22080, 3) {
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(22080, 6) {
...
REGISTER_CREATE_SKILL_NODE(22080, 6) {
    ...
    if (variables != nullptr) {
        node6->setA(variables->getVariable<int32_t>(Variable_22080_Damage));
    }
    return node6;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22080, 7) {
...
REGISTER_CREATE_SKILL_NODE(22080, 7) {
    ...
    if (node7 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 7, node7)
    }
    if (noInit == true) {
        return node7;
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(22080, 8) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(22080, 9) {
...
REGISTER_CREATE_SKILL_NODE(22080, 9) {
    ...
    if (node9 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 9, node9)
    }
    if (noInit == true) {
        return node9;
    }
...
// PlayEffect
//
REGISTER_REGISTER_SKILL_NODE(22080, 10) {
...
REGISTER_CREATE_SKILL_NODE(22080, 10) {
    ...
    if (node10 == nullptr) {
        ...
        node10->setScale(.00f);
        CALL_REGISTER_SKILL_NODE(22080, 10, node10)
    }
    if (noInit == true) {
        return node10;
    }
...
// Delay
//
REGISTER_REGISTER_SKILL_NODE(22080, 11) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(22080, 12) {
    pnode->resizeTrigger(PhaseNode_PlayAnimation::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22080, 12) {
    ...
    if (node12 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 12, node12)
    }
    if (noInit == true) {
        return node12;
    }
...
// RemoveSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(22080, 13) {
...
REGISTER_CREATE_SKILL_NODE(22080, 13) {
    ...
    if (node13 == nullptr) {
        ...
        node13->setTarget(0U);
        CALL_REGISTER_SKILL_NODE(22080, 13, node13)
    }
    if (noInit == true) {
        return node13;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22080, 14) {
}

REGISTER_CREATE_SKILL_NODE(22080, 14) {
    ...
    if (node14 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 14, node14)
    }
    if (noInit == true) {
        return node14;
    }
...
// IntOperation
//
REGISTER_REGISTER_SKILL_NODE(22080, 16) {
...
REGISTER_CREATE_SKILL_NODE(22080, 16) {
    ...
    if (node16 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 16, node16)
    }
    if (noInit == true) {
        return node16;
    }
    ...
    if (variables != nullptr) {
        node16->setBase(variables->getVariable<int32_t>(Variable_22080_Damage));
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(22080, 17) {
    pnode->resizeTrigger(PhaseNode_SetInt::TRIGGER_MAX);
...
// If
//
REGISTER_REGISTER_SKILL_NODE(22080, 19) {
...
REGISTER_CREATE_SKILL_NODE(22080, 19) {
    auto node19 = GET_SKILL_NODE(19, PhaseNode_If);
    if (node19 == nullptr) {
        node19 = new PhaseNode_If(19, phase);
        CALL_REGISTER_SKILL_NODE(22080, 19, node19)
    }
    if (noInit == true) {
        return node19;
    }
    ...
    if (variables != nullptr) {
        node19->setCondition(variables->getVariable<bool>(Variable_22080_EnableDmg));
    }
    return node19;
}
//--------------------------------------------------------------------------------
...
// AddSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(22080, 23) {
...
REGISTER_CREATE_SKILL_NODE(22080, 23) {
    ...
    if (node23 == nullptr) {
        ...
        node23->setTarget(0U);
        node23->setAttribute({{}});
        CALL_REGISTER_SKILL_NODE(22080, 23, node23)
    }
    if (noInit == true) {
        return node23;
    }
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(22080, 24) {
    pnode->resizeTrigger(PhaseNode_CompareInt::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22080, 27) {
    ...
    if (variables != nullptr) {
        node27->setCondition(variables->getVariable<bool>(Variable_22080_Effect));
    }
    return node27;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22080, 29) {
    pnode->resizeTrigger(PhaseNode_SetBool::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(22080, 29) {
    ...
    if (node29 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 29, node29)
    }
    if (noInit == true) {
        return node29;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(22080, 30) {
}

REGISTER_CREATE_SKILL_NODE(22080, 30) {
    ...
    if (node30 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 30, node30)
    }
    if (noInit == true) {
        return node30;
    }
...
// CompareFloat
//
REGISTER_REGISTER_SKILL_NODE(22080, 31) {
...
// SkillEndNotify
//
REGISTER_REGISTER_SKILL_NODE(22080, 32) {
}

REGISTER_CREATE_SKILL_NODE(22080, 32) {
    ...
    if (node32 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 32, node32)
    }
    if (noInit == true) {
        return node32;
    }
...
// RaiseEvent
//
REGISTER_REGISTER_SKILL_NODE(22080, 33) {
...
REGISTER_CREATE_SKILL_NODE(22080, 33) {
    ...
    if (node33 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(22080, 33, node33)
    }
    if (noInit == true) {
        return node33;
    }
...
// Detect
//
REGISTER_REGISTER_SKILL_NODE(22080, 34) {
...
REGISTER_CREATE_SKILL_NODE(22080, 34) {
    auto node34 = GET_SKILL_NODE(34, PhaseNode_Detect);
    if (node34 == nullptr) {
        ...
        node34->setMarkID(0);
        CALL_REGISTER_SKILL_NODE(22080, 34, node34)
    }
    if (noInit == true) {
        return node34;
    }
...
// SkillCreator_22080
//
class SkillCreator_22080 : public SkillCreator {
public:
    SkillCreator_22080() {}
    virtual ~SkillCreator_22080() {}
    virtual SkillLogic* createSkill(Skill* skill, SkillableActor* owner, uint16_t nId);
    virtual bool getSkillExpend(int32_t& nType, int32_t& nValue);
}; // class SkillCreate_22080

//--------------------------------------------------------------------------------
// SkillPhase_22080
//
class SkillPhase_22080 : public SkillPhase {
public:
    SkillPhase_22080(uint16_t id, SkillLogic* logic, uint16_t nFlow) : SkillPhase(id, logic, nFlow) {}
    virtual ~SkillPhase_22080() {}

    virtual SkillPhaseNode* createPhaseNode(uint16_t nId, bool noInit) {
        SWITCH_CREATE_SKILL_START
        CASE_CREATE_SKILL_NODE(22080, 3) // StartPhase
        CASE_CREATE_SKILL_NODE(22080, 6) // CompareInt
        CASE_CREATE_SKILL_NODE(22080, 7) // SetBool
        CASE_CREATE_SKILL_NODE(22080, 8) // SetInt
        CASE_CREATE_SKILL_NODE(22080, 9) // PlayAnimation
        CASE_CREATE_SKILL_NODE(22080, 10) // PlayEffect
        CASE_CREATE_SKILL_NODE(22080, 11) // Delay
        CASE_CREATE_SKILL_NODE(22080, 12) // PlayAnimation
        CASE_CREATE_SKILL_NODE(22080, 13) // RemoveSkillBuff
        CASE_CREATE_SKILL_NODE(22080, 14) // SetBool
        CASE_CREATE_SKILL_NODE(22080, 16) // IntOperation
        CASE_CREATE_SKILL_NODE(22080, 17) // SetInt
        CASE_CREATE_SKILL_NODE(22080, 19) // If
        CASE_CREATE_SKILL_NODE(22080, 20) // Delay
        CASE_CREATE_SKILL_NODE(22080, 23) // AddSkillBuff
        CASE_CREATE_SKILL_NODE(22080, 24) // CompareInt
        CASE_CREATE_SKILL_NODE(22080, 25) // Delay
        CASE_CREATE_SKILL_NODE(22080, 27) // If
        CASE_CREATE_SKILL_NODE(22080, 29) // SetBool
        CASE_CREATE_SKILL_NODE(22080, 30) // SetBool
        CASE_CREATE_SKILL_NODE(22080, 31) // CompareFloat
        CASE_CREATE_SKILL_NODE(22080, 32) // SkillEndNotify
        CASE_CREATE_SKILL_NODE(22080, 33) // RaiseEvent
        CASE_CREATE_SKILL_NODE(22080, 34) // Detect
        SWITCH_CREATE_SKILL_END
    }
}; // class SkillPhase_22080

SkillLogic* SkillCreator_22080::createSkill(Skill* skill, SkillableActor* owner, uint16_t nId) {
    //创建执行逻辑
    auto logic = new SkillLogic(nId, owner, skill);
    //设置变量
    Variable_22080_Damage = logic->getVariables().setVariable<int32_t>("Damage");
    Variable_22080_EnableDmg = logic->getVariables().setVariable<bool>("EnableDmg", true);
    Variable_22080_Effect = logic->getVariables().setVariable<bool>("Effect", true);
    //创建阶段phase
    auto phase = new SkillPhase_22080(1, logic, 2);
    //设置phase执行器
...
bool SkillCreator_22080::getSkillExpend(int32_t& nType, int32_t& nValue) {
    return true;
}
} // namespace pvp
