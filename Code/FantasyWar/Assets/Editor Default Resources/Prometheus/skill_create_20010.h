...
//变量声明
uint64_t Variable_20010_Damage = 0;
uint64_t Variable_20010_EnableDmg = 0;
uint64_t Variable_20010_Effect = 0;
//--------------------------------------------------------------------------------
// StartPhase
//
REGISTER_REGISTER_SKILL_NODE(20010, 11) {
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(20010, 13) {
...
REGISTER_CREATE_SKILL_NODE(20010, 13) {
    ...
    if (variables != nullptr) {
        node13->setA(variables->getVariable<int32_t>(Variable_20010_Damage));
    }
    return node13;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(20010, 14) {
...
REGISTER_CREATE_SKILL_NODE(20010, 14) {
    ...
    if (node14 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 14, node14)
    }
    if (noInit == true) {
        return node14;
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(20010, 15) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(20010, 16) {
...
REGISTER_CREATE_SKILL_NODE(20010, 16) {
    ...
    if (node16 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 16, node16)
    }
    if (noInit == true) {
        return node16;
    }
...
// PlayEffect
//
REGISTER_REGISTER_SKILL_NODE(20010, 17) {
...
REGISTER_CREATE_SKILL_NODE(20010, 17) {
    ...
    if (node17 == nullptr) {
        ...
        node17->getVars().setVariable<std::string>(1, "");
        ...
        node17->setScale(.00f);
        CALL_REGISTER_SKILL_NODE(20010, 17, node17)
    }
    if (noInit == true) {
        return node17;
    }
...
// Delay
//
REGISTER_REGISTER_SKILL_NODE(20010, 18) {
...
// PlayAnimation
//
REGISTER_REGISTER_SKILL_NODE(20010, 19) {
    pnode->resizeTrigger(PhaseNode_PlayAnimation::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(20010, 19) {
    ...
    if (node19 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 19, node19)
    }
    if (noInit == true) {
        return node19;
    }
...
// RemoveSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(20010, 20) {
...
REGISTER_CREATE_SKILL_NODE(20010, 20) {
    ...
    if (node20 == nullptr) {
        ...
        node20->setTarget(0U);
        CALL_REGISTER_SKILL_NODE(20010, 20, node20)
    }
    if (noInit == true) {
        return node20;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(20010, 21) {
}

REGISTER_CREATE_SKILL_NODE(20010, 21) {
    ...
    if (node21 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 21, node21)
    }
    if (noInit == true) {
        return node21;
    }
...
// IntOperation
//
REGISTER_REGISTER_SKILL_NODE(20010, 23) {
...
REGISTER_CREATE_SKILL_NODE(20010, 23) {
    ...
    if (node23 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 23, node23)
    }
    if (noInit == true) {
        return node23;
    }
    ...
    if (variables != nullptr) {
        node23->setBase(variables->getVariable<int32_t>(Variable_20010_Damage));
    }
...
// SetInt
//
REGISTER_REGISTER_SKILL_NODE(20010, 24) {
    pnode->resizeTrigger(PhaseNode_SetInt::TRIGGER_MAX);
...
// If
//
REGISTER_REGISTER_SKILL_NODE(20010, 26) {
...
REGISTER_CREATE_SKILL_NODE(20010, 26) {
    auto node26 = GET_SKILL_NODE(26, PhaseNode_If);
    if (node26 == nullptr) {
        node26 = new PhaseNode_If(26, phase);
        CALL_REGISTER_SKILL_NODE(20010, 26, node26)
    }
    if (noInit == true) {
        return node26;
    }
    ...
    if (variables != nullptr) {
        node26->setCondition(variables->getVariable<bool>(Variable_20010_EnableDmg));
    }
    return node26;
}
//--------------------------------------------------------------------------------
...
// AddSkillBuff
//
REGISTER_REGISTER_SKILL_NODE(20010, 30) {
...
REGISTER_CREATE_SKILL_NODE(20010, 30) {
    ...
    if (node30 == nullptr) {
        ...
        node30->setTarget(0U);
        node30->setAttribute({{}});
        CALL_REGISTER_SKILL_NODE(20010, 30, node30)
    }
    if (noInit == true) {
        return node30;
    }
...
// CompareInt
//
REGISTER_REGISTER_SKILL_NODE(20010, 31) {
    pnode->resizeTrigger(PhaseNode_CompareInt::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(20010, 34) {
    ...
    if (variables != nullptr) {
        node34->setCondition(variables->getVariable<bool>(Variable_20010_Effect));
    }
    return node34;
}
//--------------------------------------------------------------------------------
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(20010, 36) {
    pnode->resizeTrigger(PhaseNode_SetBool::TRIGGER_MAX);
...
REGISTER_CREATE_SKILL_NODE(20010, 36) {
    ...
    if (node36 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 36, node36)
    }
    if (noInit == true) {
        return node36;
    }
...
// SetBool
//
REGISTER_REGISTER_SKILL_NODE(20010, 37) {
}

REGISTER_CREATE_SKILL_NODE(20010, 37) {
    ...
    if (node37 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 37, node37)
    }
    if (noInit == true) {
        return node37;
    }
...
// CompareFloat
//
REGISTER_REGISTER_SKILL_NODE(20010, 38) {
...
// SkillEndNotify
//
REGISTER_REGISTER_SKILL_NODE(20010, 39) {
}

REGISTER_CREATE_SKILL_NODE(20010, 39) {
    ...
    if (node39 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 39, node39)
    }
    if (noInit == true) {
        return node39;
    }
...
// RaiseEvent
//
REGISTER_REGISTER_SKILL_NODE(20010, 40) {
...
REGISTER_CREATE_SKILL_NODE(20010, 40) {
    ...
    if (node40 == nullptr) {
        ...
        CALL_REGISTER_SKILL_NODE(20010, 40, node40)
    }
    if (noInit == true) {
        return node40;
    }
...
// Detect
//
REGISTER_REGISTER_SKILL_NODE(20010, 41) {
...
REGISTER_CREATE_SKILL_NODE(20010, 41) {
    auto node41 = GET_SKILL_NODE(41, PhaseNode_Detect);
    if (node41 == nullptr) {
        ...
        node41->setMarkID(0);
        CALL_REGISTER_SKILL_NODE(20010, 41, node41)
    }
    if (noInit == true) {
        return node41;
    }
...
// SkillCreator_20010
//
class SkillCreator_20010 : public SkillCreator {
public:
    SkillCreator_20010() {}
    virtual ~SkillCreator_20010() {}
    virtual SkillLogic* createSkill(Skill* skill, SkillableActor* owner, uint16_t nId);
    virtual bool getSkillExpend(int32_t& nType, int32_t& nValue);
}; // class SkillCreate_20010

//--------------------------------------------------------------------------------
// SkillPhase_20010
//
class SkillPhase_20010 : public SkillPhase {
public:
    SkillPhase_20010(uint16_t id, SkillLogic* logic, uint16_t nFlow) : SkillPhase(id, logic, nFlow) {}
    virtual ~SkillPhase_20010() {}

    virtual SkillPhaseNode* createPhaseNode(uint16_t nId, bool noInit) {
        SWITCH_CREATE_SKILL_START
        CASE_CREATE_SKILL_NODE(20010, 11) // StartPhase
        CASE_CREATE_SKILL_NODE(20010, 13) // CompareInt
        CASE_CREATE_SKILL_NODE(20010, 14) // SetBool
        CASE_CREATE_SKILL_NODE(20010, 15) // SetInt
        CASE_CREATE_SKILL_NODE(20010, 16) // PlayAnimation
        CASE_CREATE_SKILL_NODE(20010, 17) // PlayEffect
        CASE_CREATE_SKILL_NODE(20010, 18) // Delay
        CASE_CREATE_SKILL_NODE(20010, 19) // PlayAnimation
        CASE_CREATE_SKILL_NODE(20010, 20) // RemoveSkillBuff
        CASE_CREATE_SKILL_NODE(20010, 21) // SetBool
        CASE_CREATE_SKILL_NODE(20010, 23) // IntOperation
        CASE_CREATE_SKILL_NODE(20010, 24) // SetInt
        CASE_CREATE_SKILL_NODE(20010, 26) // If
        CASE_CREATE_SKILL_NODE(20010, 27) // Delay
        CASE_CREATE_SKILL_NODE(20010, 30) // AddSkillBuff
        CASE_CREATE_SKILL_NODE(20010, 31) // CompareInt
        CASE_CREATE_SKILL_NODE(20010, 32) // Delay
        CASE_CREATE_SKILL_NODE(20010, 34) // If
        CASE_CREATE_SKILL_NODE(20010, 36) // SetBool
        CASE_CREATE_SKILL_NODE(20010, 37) // SetBool
        CASE_CREATE_SKILL_NODE(20010, 38) // CompareFloat
        CASE_CREATE_SKILL_NODE(20010, 39) // SkillEndNotify
        CASE_CREATE_SKILL_NODE(20010, 40) // RaiseEvent
        CASE_CREATE_SKILL_NODE(20010, 41) // Detect
        SWITCH_CREATE_SKILL_END
    }
}; // class SkillPhase_20010

SkillLogic* SkillCreator_20010::createSkill(Skill* skill, SkillableActor* owner, uint16_t nId) {
    //创建执行逻辑
    auto logic = new SkillLogic(nId, owner, skill);
    //设置变量
    Variable_20010_Damage = logic->getVariables().setVariable<int32_t>("Damage");
    Variable_20010_EnableDmg = logic->getVariables().setVariable<bool>("EnableDmg", true);
    Variable_20010_Effect = logic->getVariables().setVariable<bool>("Effect", true);
    //创建阶段phase
    auto phase = new SkillPhase_20010(1, logic, 2);
    //设置phase执行器
...
bool SkillCreator_20010::getSkillExpend(int32_t& nType, int32_t& nValue) {
    return true;
}
} // namespace pvp
