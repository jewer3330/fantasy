...
public class ResTool  {
    ...
    [MenuItem("Tools/打包/压缩资源包", false, 7)]
    ...
    [MenuItem("Tools/打包/删除上次生成的文件 and 拷贝流媒体到版本资源目录", false, 9)]
    public static void CopyStreamingToRes()
    {
        ...
        //FileUtilTool.DelFile("Assets/StreamingAssets/url.dat");
        //FileUtilTool.DelFile("Assets/StreamingAssets/config.dat");
...
//#endif
    ...
    [MenuItem("Tools/打包/生成资源的MD5文件", false, 11)]
    ...
    [MenuItem("Tools/打包/生成MD5文件的MD5", false, 12)]
    ...
    [MenuItem("Tools/打包/本地加密资源", false, 10)]
    ...
    [MenuItem("Tools/打包/上传资源", false, 13)]
    public static void UploadRes()
    {
        string sourcePath = ResSetting.build_res_path;
        string targetPath = string.Format("F:/nginx-1.10.3/html/tankwar/{0}/{1}", ResSetting.GetChannelRes(), Version.LoadVersionFromStreamingAsset());
    ...
    [MenuItem("Tools/打包/本地解密资源", false, 14)]
    ...
    public static void BuildLocalRes()
    {
        try
        {
            ...
            AndroidOneKeyTool.buildLog.First();

            MarkTool.ClearMarkForce();

            AndroidOneKeyTool.buildLog.Next();
            ...
            AndroidOneKeyTool.buildLog.End();
            AndroidOneKeyTool.SaveBuildLog(AndroidOneKeyTool.buildLog);
        ...
        {
            AndroidOneKeyTool.buildLog.errorLog = e.ToString();
            AndroidOneKeyTool.SaveBuildLog(AndroidOneKeyTool.buildLog);
            Debug.LogError(e);
        }
